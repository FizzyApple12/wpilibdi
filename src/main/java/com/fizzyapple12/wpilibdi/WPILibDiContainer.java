...
public class WPILibDiContainer extends DiContainer {
    ...
    *
    * @see com.fizzyapple12.javadi.DiContext
    */
    ...
    * @throws com.fizzyapple12.javadi.DiExceptions.RuleBuilderException Caused by having an improper configuration prior to trying to set resolution
    * @see com.fizzyapple12.javadi.DiRule
    */
    ...
    * @return A new RuleBuilder 
    * @throws java.lang.IllegalAccessException Can be caused by the reflection, out of my control
    * @throws java.lang.reflect.InvocationTargetException Can be caused by the reflection, out of my control
    * @throws java.lang.InstantiationException Can be caused if the Container fails to instantiate a class
    * @see com.fizzyapple12.javadi.DiRule
    */
